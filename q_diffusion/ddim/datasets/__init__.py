...
from ddim.datasets.artcifar10 import artCIFAR10
from ddim.datasets.celeba import CelebA
from ddim.datasets.ffhq import FFHQ
from ddim.datasets.lsun import LSUN
...
def inverse_data_transform(config, X):
    ...
    if config.data.logit_transform:
        X = torch.sigmoid(X)
    elif config.data.rescaled:#true for cifar
        X = (X + 1.0) / 2.0
